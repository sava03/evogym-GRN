...
from utils.metrics import METRICS_ABS, METRICS_REL, METRICS_BEHAVIORAL
...
class Individual:
    def __init__(self, genome, id_counter, parent1_id=None, parent2_id=None):
        ...
        for m in METRICS_ABS:
            # behavioral metrics start at -inf to indicate "not yet evaluated"
            if m in METRICS_BEHAVIORAL:
